...
const AboutUs = () => {
  return (
    ...
    <div className="min-h-screen w-full">
        ...
        <div className="container mx-auto px-4 ">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 ">
            {teamMembers.map((member, index) => (
              <div
                key={index}
                className="bg-blue-200 rounded-xl shadow-md p-4 md:p-6 text-center transform transition hover:scale-105 hover:shadow-lg"
              >
                <Image
                  src={member.image}
                  alt={member.name}
      ...
      <section className="bg-gradient-to-r from-blue-300 to-blue-200 text-white py-12 md:py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl md:text-3xl font-bold text-center mb-8 md:mb-12 text-black">
            Contact Us
          </h2>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
            <div className="bg-gradient-to-r from-blue-400 to-blue-200 p-4 md:p-6 rounded-xl text-center">
