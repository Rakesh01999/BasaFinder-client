...
const TenantHomePage = () => {
  return (
    ...
    // <div className="bg-gradient-to-br from-gray-50 via-blue-100 to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center px-4">
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-100 to-gray-50 dark:from-gray-900 dark:via-gray-700 dark:to-gray-900 flex flex-col items-center justify-center gap-4 px-4">
      <div className="max-w-4xl md:w-full text-center p-8 bg-white dark:bg-gray-900 shadow-lg rounded-2xl border border-gray-200 dark:border-gray-700">
        ...
        <div className="mt-10">
          <p className="text-base md:text-lg text-gray-600 dark:text-gray-400">
            Manage listings, tenant requests, and manage all users -landlords,
