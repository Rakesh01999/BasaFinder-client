...
import { Users, Home, DollarSign, Activity, Building } from "lucide-react";
...
const TenantHomePage = () => {
  ...
  const getDashboardStats = () => {
    ...
    const totalRent = initialListings.reduce(
      (sum, listing) => sum + (listing.rentAmount || 0),
      0
    );
    const averageRent =
      totalListings > 0 ? Math.round(totalRent / totalListings) : 0;
        ...
        <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/listings">
              <Button
                variant="default"
                className="rounded-full text-white dark:text-white bg-blue-600 hover:bg-green-700 px-8 py-3"
              >
                All Listings
              </Button>
            </Link>
            <Link href="/tenants/requests">
              <Button
                variant="default"
                className="rounded-full text-white dark:text-white bg-blue-600 hover:bg-purple-700 px-8 py-3"
              >
                My Rent Requests
              </Button>
            </Link>
