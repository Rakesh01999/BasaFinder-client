...
const TenantHomePage = () => {
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-100 to-gray-50 dark:from-gray-900 dark:via-gray-700 dark:to-gray-900 flex flex-col items-center justify-center px-4 gap-5">
      ...
      <div className="max-w-4xl w-full text-center p-8 bg-white dark:bg-gray-900 shadow-lg rounded-2xl border border-gray-200 dark:border-gray-700">
        ...
        <p className="text-lg md:text-xl lg:text-2xl font-medium text-gray-700 dark:text-gray-300 animate-pulse">
          Please click dropdown button from sidebar for more options.
        </p>
        <div className="mt-10">
